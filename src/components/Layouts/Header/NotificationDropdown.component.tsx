    ...
    return (
        <>
            <div className="relative" ref={dropdownRef}>
                ...
                {isOpen && (
                    <div 
                        className={`macos26-notification-dropdown ${isMobile ? 'macos26-notification-dropdown-mobile notification-mobile-enter' : ''}`}
                        role="menu"
                        ...
                        {notifications && notifications.length > 0 && (
                            <div className="macos26-notification-footer">
                                {isMobile && unreadCount > 0 && (
                                    <button 
                                        onClick={handleMarkAllAsRead}
                                        className="macos26-btn macos26-btn-primary macos26-btn-sm w-full mb-2"
                                        disabled={loading}
                                    >
